        ...
        <div className={`w-full group`}>
            <div className='relative'>
                ...
                <div className={`flex flex-col justify-start gap-1 p-5 bg-black rounded-b-lg bg-opacity-40 absolute bottom-0 w-full `}>
                    ...
                    <p className='text-xs lg:text-sm xl:text-base capitalize text-white opacity-100 lg:hidden transition-all ease-in-out delay-300 lg:group-hover:block'>{props.products} Products </p>
                </div>
            </div>
        </div>
    )
